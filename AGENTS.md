...
You are working with APM — Ashraellen Project Memory.

Core rule:
Use this repository as a structured external memory for Ashraellen's projects.
...
- Do not simplify philosophical density unless asked.
- Do not smooth out satire, irony, pressure, or ambiguity.
