...
Approved English final files live here:
...
They described Creation itself.

The world was already the Manna-machine.
...
Research-to-literature core:

```text
Internal research -> literary embodiment -> accessible public form.

Внутреннее исследование -> художественное воплощение -> доступная литературная форма.
```
...
- a dull philosophical treatise;
- research disguised as fantasy;
- fantasy used as decoration for theory;
...
The research must not become a lecture.
It must become readable literature.
```
