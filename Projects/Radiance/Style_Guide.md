...
- ironic;
- inconvenient;
- too calm in the wrong places;
- unwilling to prove what he says;
- familiar with things he should not know.
...
Humor should be rare enough to cut and ordinary enough to keep the text alive.
...
Do not explain the mechanism too early.
...
The reader should not be forced to choose whether the ancient Teachers are:
...
- language-forms;
- divine functions;
- or something that cannot be flattened into one category.

The series loses power if it becomes either pure fantasy lore or pure symbolic essay.

Correct state:

```text
The story is true in more than one way.
```
...
```text
This is an authorial artistic-philosophical return to material that was part of the author's earlier spiritual search, now treated carefully as one source of a fictional and research-based northern cycle.
```
