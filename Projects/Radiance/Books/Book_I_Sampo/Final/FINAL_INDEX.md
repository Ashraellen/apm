...
```text
Chapter 08 — Final/Chapter_08_final_v1.md
```

Recommended next action:

```text
Controller should review Chapter_08_final_v1.md.
```

Do not begin Chapter 09 until Chapter 08 is either approved or explicitly put aside by the author.
...
| 8 | Chapter 08 | `Drafts/Chapter_08_v2.md` | `Chapter_08_final_v1.md` | awaiting controller approval | — | Final proofread v1 created; pending controller review. |
...
| Chapter 08 | — | — | not created | Awaiting controller approval. |
