...
```text
Chapter 14 — Final/Chapter_14_final_v1.md
```

Recommended next action:

```text
Controller should review Chapter_14_final_v1.md.
```

Do not begin Chapter 15 until Chapter 14 is either approved or explicitly put aside by the author.
...
| 14 | Chapter 14 | `Drafts/Chapter_14_v1.md` | `Chapter_14_final_v1.md` | awaiting controller approval | — | Final proofread v1 created; pending controller review. |
...
| Chapter 14 | — | — | not created | Awaiting controller approval. |
