...
```text
Chapter 21 — Final/Chapter_21_final_v1.md
```

Recommended next action:

```text
Controller should review Chapter_21_final_v1.md.
```

Do not begin Chapter 22 until Chapter 21 is either approved or explicitly put aside by the author.
...
| 21 | Chapter 21 | `Drafts/Chapter_21_v1.md` | `Chapter_21_final_v1.md` | awaiting controller approval | — | Final proofread v1 created; pending controller review. |
...
| Chapter 21 | — | — | not created | Awaiting controller approval. |
