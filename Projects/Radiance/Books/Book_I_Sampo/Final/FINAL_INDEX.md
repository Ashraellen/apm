...
```text
Chapter 04 — Drafts/Chapter_04_v2.md
```

Recommended next action:

```text
Proofreader should start with Chapter 04 only.
```

Do not begin Chapter 05 until Chapter 04 is either approved or explicitly put aside by the author.
...
| 3 | Chapter 03 | `Drafts/Chapter_03_v3.md` | `Chapter_03_final_v2.md` | approved final after micro-corrections | approve after micro-corrections | Restored final block from source draft after controller review. |
| 4 | Chapter 04 | `Drafts/Chapter_04_v2.md` | — | not started | — | Start here. |
...
| Chapter 03 | `Chapter_03_final_v2.md` | — | not created | Approved after micro-corrections; local DOCX may now be created. |
